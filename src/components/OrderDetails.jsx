       ...
       {  order !== undefined  && (  <main>
          ...
          <article>
            ...
            <div>
              <h4>Cheese Burger</h4>
              <div>
                <span>{order.orderItems.paneerPizza.quantity}</span> x{" "}
                <span>{order.orderItems.paneerPizza.price}</span>
              </div>
            </div>
            <div>
              <h4>Veg Cheese Burger</h4>
              <div>
                <span>{order.orderItems.cheesePizza.quantity}</span> x{" "}
                <span>{order.orderItems.cheesePizza.price}</span>
              </div>
            </div>
            <div>
              <h4>Burger Fries</h4>
              <div>
                <span>{order.orderItems.capsicumPizza.quantity}</span> x{" "}
                <span>{order.orderItems.capsicumPizza.price}</span>
              </div>
            </div>
